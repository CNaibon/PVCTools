...
int SegmentFA(int argc,char *argv[])
{
    ...
    snprintf(ShellCommand, sizeof(ShellCommand), "touch %s/tmp", PathWork);
    system(ShellCommand);
    ...
    else
    {
        ...
        while((ptr = readdir(dir)) != NULL)
        {
            ...
            snprintf(ShellCommand, sizeof(ShellCommand), "du -h --block-size=M %s/fa/%s > %s/tmp", PathWork, ptr->d_name, PathWork);
            system(ShellCommand);
            snprintf(ShellCommand, sizeof(ShellCommand), "%s/tmp", PathWork);
    ...
    {
        snprintf(ShellCommand, sizeof(ShellCommand), "du -h --block-size=M %s/fa/%s.fa > %s/tmp ", PathWork, ChrName[i].c_str(), PathWork);
        system(ShellCommand);
        snprintf(ShellCommand, sizeof(ShellCommand), "%s/tmp", PathWork);
        fp_Tmp.open(ShellCommand,ios::in);
        getline(fp_Tmp, Buffer);
        ...
        snprintf(ShellCommand, sizeof(ShellCommand), "ls -l %s/fa/%s |grep \"^-\" |wc -l > %s/tmp ", PathWork, ChrName[i].c_str(), PathWork);
        system(ShellCommand);
        snprintf(ShellCommand, sizeof(ShellCommand), "%s/tmp", PathWork);
        fp_Tmp.open(ShellCommand,ios::in);
        getline(fp_Tmp, Buffer);
        ...
        if (Reserve != 0)
        {
            ...
            snprintf(ShellCommand, sizeof(ShellCommand), "wc -L %s/fa/%s.fa > %s/tmp", PathWork, ChrName[i].c_str(), PathWork);
            system(ShellCommand);
            snprintf(ShellCommand, sizeof(ShellCommand), "%s/tmp", PathWork);
