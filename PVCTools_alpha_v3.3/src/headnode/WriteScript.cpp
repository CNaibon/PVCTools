...
int main(int argc, char *argv[])
{
    ...
    else if (argc == 2)
    {
        ...
        {
            std::cout << "\t./PVCTools SegmentFA <-w WorkPath> <-n SplitNumber> [-lm Size] [-R Reserved values] [-q Queue] [-cpu CPU] [-span Span]" << std::endl;
            std::cout << "\tRequired Parameters:" << std::endl;
            std::cout << "\t\t-w               : Working directory path for using to store the generated files." << std::endl;
        ...
        {
            std::cout << "\t./PVCTools Submit <-w WorkPath> <-n SplitNumber> [-single] [-R Reserved values] [-T Tools] [-P Tool'sParameters] [-q Queue] [-single]" << std::endl;
            std::cout << "\tRequired Parameters:" << std::endl;
            std::cout << "\t\t-w               : Working directory path for using to store the generated files." << std::endl;
            std::cout << "\t\t-n               : The number of divisions." << std::endl;
            std::cout << "\tOptional Parameters:" << std::endl;
        ...
        {
            std::cout << "\t./PVCTools GetVCF <-w WorkPath> <-fa FAPath> <-bam BAMPath> <-n SplitNumber> [-lm Size] [-R Reserved values] [-I] [-T Tools] [-P Tool'sParameters] [-q Queue] [-cpu CPU] [-span Span]" << std::endl;
            std::cout << "\tRequired Parameters:" << std::endl;
            std::cout << "\t\t-w               : Working directory path for using to store the generated files." << std::endl;
            std::cout << "\t\t-fa              : The path of the original FA file."<< std::endl;
            std::cout << "\t\t-n               : The number of divisions." << std::endl;
